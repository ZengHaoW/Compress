function [encryptedImage] = DNA_JIAMI(image, x, y, z, h)
    ...
    Q_1 = DNABIAN(fenkuai(t, image, 1), x(1));
    Q_last = DNAYUNSUAN(Q_1, R_1, z(1));
    Q_B(1:t, 1:t) = DNAJIE(Q_last, h(1));
    e = nums / t / t;

    for i = 2:e
        R_1 = DNABIAN(fenkuai(t, R, i), x(i));
        Q_1 = DNABIAN(fenkuai(t, image, i), x(i));
        Q_2 = DNAYUNSUAN(Q_1, R_1, z(i));
        Q_3 = DNAYUNSUAN(Q_2, Q_last, z(i));
        Q_last = Q_3;
        ...
        Q_B = fuzhi(t, Q_B, i, DNAJIE(Q_3, h(i)));
    end
